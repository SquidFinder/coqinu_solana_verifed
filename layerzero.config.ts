...
const avalancheTokenProxy: OmniPointHardhat = {
...
const ethereumTokenContract: OmniPointHardhat = {
...
const config: OAppOmniGraphHardhat = {
    contracts: [
        ...
        {
            contract: avalancheTokenProxy,
        },
        {
            contract: arbitrumTokenContract,
        },
	{
            contract: ethereumTokenContract,
        },
        {
    ...
    connections: [
		...
		config: {
			sendLibrary: getEndpointAddress('ethereum', 'SendLib302'),
			receiveLibraryConfig: {
			  receiveLibrary: getEndpointAddress('ethereum', 'ReceiveLib302'),
			  gracePeriod: BigInt(0),
			},
			sendConfig: {
			  executorConfig: {
			    maxMessageSize: 10000,
			    executor: getEndpointAddress('ethereum', 'LZExecutor'),
			  },
			  ulnConfig: {
			    confirmations: BigInt(5),
			    requiredDVNs: [
			    	getDVNAddress('ethereum', 'lz_labs'),
			    	getDVNAddress('ethereum', 'google_cloud')			    
			    ],
			    optionalDVNs: [
			    	getDVNAddress('ethereum', 'bware'),
				getDVNAddress('ethereum', 'horizen_labs'),
				getDVNAddress('ethereum', 'nethermind')				
			    ],
